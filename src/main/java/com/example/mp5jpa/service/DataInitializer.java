...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        if (artistRepository.count() == 0) {
            ...
            Song tuTuNeurotic = new Song("Tu Tu Neurotic", theHellp, 180, "Pop", "resources/audio/tutuneurotic.wav", "/tutu.jpg");
            thAlbum.addSong(tuTuNeurotic);

            Album hotTimeAlbum = new Album("Hot Times", enya, LocalDate.parse("2024-01-15"));
            Song onlyTime = new Song("Only Hot Time", enya, 194, "Blend", "resources/audio/onlyhottime.wav", "/onlyhottime.jpg");
            hotTimeAlbum.addSong(onlyTime);

            albumRepository.saveAll(List.of(thAlbum, hotTimeAlbum));

            Song smoothJazz = new Song("Smooth Jazz", skepta, 210, "Grime & Jazz", "resources/audio/skeptajazz.wav", "/jazz.jpg");
            Song sdp = new Song("SDP", travis, 300, "Rap", "resources/audio/sdpeyes.wav", "/sdp.jpg");
